      ...
      <nav className="container-tt flex items-center justify-between py-4">
        <NavLink to="/" className="flex items-center gap-3 group" onClick={() => setOpen(false)}>
          <img
            ...
            alt={site.name}
            className="h-10 w-10 rounded-full object-cover ring-1 ring-forest/20 shrink-0"
          />
          <span className="leading-tight">
            <span className="block font-display text-xl tracking-tight text-forest">
              {site.shortName}
            </span>
            <span className="block font-mono text-[10px] tracking-widest2 uppercase text-brass -mt-0.5">
              &amp; Industrie Mobile
            </span>
          </span>
        </NavLink>
